...
public class ClientLogin extends JFrame {
	...
	public ClientLogin(String id, String pw) {
		...
		// »Øøµ æ»≥ª Label
		JLabel wellcomeLb = new JLabel(id+"¥‘ »Øøµ«’¥œ¥Ÿ¢Ω");
		wellcomeLb.setFont(new Font("±º∏≤", Font.BOLD, 20));
		...
		CSearchBtn.setFont(new Font("±º∏≤", Font.BOLD, 20));
		...
		cLogoutBtn.setFont(new Font("±º∏≤", Font.BOLD, 15));
